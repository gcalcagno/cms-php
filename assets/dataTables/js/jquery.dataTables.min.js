...
sEmptyTable:"No hay datos disponibles en la tabla",sInfo:"Vista _START_ a _END_ de _TOTAL_ items",sInfoEmpty:"Vista 0 a 0 de 0 items",sInfoFiltered:"(Resultados de búsquda de un total de _MAX_ items)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Mostrar _MENU_ items",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Buscar:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No matching records found"},oSearch:h.extend({},p.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",sPaginationType:"simple_numbers",
